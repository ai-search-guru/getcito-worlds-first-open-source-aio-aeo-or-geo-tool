...
function isGetcitoHref(href: string): boolean {
	if (href.startsWith("/") || href.startsWith("#")) return true;
	try {
		const { hostname } = new URL(href);
		return hostname === "Getcitohq.com" || hostname.endsWith(".Getcitohq.com");
	} catch {
