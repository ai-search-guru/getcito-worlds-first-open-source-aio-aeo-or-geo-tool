...
- [Getcito](https://www.getcito.com/) → [llms.txt](https://www.getcito.com/llms.txt) (short description, many links, asks for [GitHub stars](https://github.com/ai-search-guru/getcito-worlds-first-open-source-aio-aeo-or-geo-tool))
...
For Getcito, we do both: [getcito.com/llms.txt](https://www.getcito.com/llms.txt) and [a markdown version of every docs page](https://www.getcito.com/docs/getting-started.md) (with links on every docs page to the markdown version).
