...
- [Getcito](https://www.Getcitohq.com/) → [llms.txt](https://www.Getcitohq.com/llms.txt) (short description, many links, asks for [GitHub stars](https://github.com/ai-search-guru/getcito-worlds-first-open-source-aio-aeo-or-geo-tool))
...
For Getcito, we do both: [Getcitohq.com/llms.txt](https://www.Getcitohq.com/llms.txt) and [a markdown version of every docs page](https://www.Getcitohq.com/docs/getting-started.md) (with links on every docs page to the markdown version).
