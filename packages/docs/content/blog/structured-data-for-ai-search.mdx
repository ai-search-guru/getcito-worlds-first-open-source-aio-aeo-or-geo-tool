...
```json
{
  ...
  "author": { "@type": "Organization", "name": "Getcito" }
}
```
...
```json
{
  ...
  "@type": "Organization",
  "name": "Getcito",
  "url": "https://www.Getcitohq.com",
  "sameAs": ["https://github.com/ai-search-guru/getcito-worlds-first-open-source-aio-aeo-or-geo-tool"]
}
```
