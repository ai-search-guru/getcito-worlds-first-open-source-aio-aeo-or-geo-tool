---
title: Architecture
description: How the Getcito monorepo is structured and how the pieces fit together.
---

## Monorepo Structure

Getcito is a pnpm monorepo managed by Turborepo. The codebase is split into **apps** (deployable) and **packages** (shared libraries).
