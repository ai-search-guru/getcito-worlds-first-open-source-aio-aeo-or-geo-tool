---
title: Overview
description: Run, configure, integrate with, and contribute to Getcito.
---

This guide is for developers working with Getcito — whether you're tuning a self-hosted deployment, hitting the REST API from another system, or contributing back to the open source project.
...
- **[Telemetry](/docs/developer-guide/telemetry)** — what Getcito collects and how to opt out.
