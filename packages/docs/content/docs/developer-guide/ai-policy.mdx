...
description: Guidelines for using AI coding tools when contributing to Getcito.
---

## AI Tools Are Welcome

We encourage the use of AI coding assistants (Copilot, Cursor, Claude, ChatGPT, etc.) when contributing to Getcito. AI tools can help you write code faster, understand unfamiliar parts of the codebase, and generate tests.
