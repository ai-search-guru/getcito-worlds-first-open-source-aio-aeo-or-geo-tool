...
description: Create your Getcito account and sign in for the first time.
---

## Create an Account

With Getcito running locally, open your browser to **http://localhost:1515**.

You'll see the Getcito landing page with a **Sign In** button. Click it to navigate to the login page, then click **Create an account** to register.

{/* TODO: Screenshot of the Getcito landing page */}
