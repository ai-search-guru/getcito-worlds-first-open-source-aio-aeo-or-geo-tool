...
The **Settings** section is accessible from the sidebar. It has four sub-pages for managing your Getcito configuration.
...
Configure which AI models Getcito queries:
