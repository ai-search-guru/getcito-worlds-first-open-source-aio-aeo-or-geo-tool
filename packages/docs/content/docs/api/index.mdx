---
title: Overview
description: Complete REST API documentation for Getcito's administrative API.
---

Getcito provides a REST API for managing brands, prompts, and snapshots programmatically. All endpoints require Bearer token authentication.
